...
namespace DVLD.Applications.Detain_License
{
    public partial class frmDetainLicenseApplication : Form
    {
        ...
        private async void btnDetain_Click(object sender, EventArgs e)
        {
            ...
            _DetainID = await ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DetainAsync(Convert.ToSingle(txtFineFees.Text), clsGlobal.CurrentUser.UserID);
            if (_DetainID == -1)
            {
        ...
        private async void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(object sender , ctrlDriverLicenseInfoWithFilterEventArgs e)
        {
            ...
            if (!ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.IsActive)
            {
                ...
                MessageBox.Show($"The license with ID {_SelectedLicenseID} is not active, Choise an active license.",
                                "Not Allowed",
