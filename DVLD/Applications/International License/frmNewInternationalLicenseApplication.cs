...
namespace DVLD.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private async void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(object sender , ctrlDriverLicenseInfoWithFilterEventArgs e)
        {
            ...
            int ActiveInternaionalLicenseID = await clsInternationalLicense.GetActiveInternationalLicenseIDByDriverIDAsync(ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DriverID);
        ...
        private async void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            //lblFees.Text = await clsApplicationType.FindByAsync((int)clsApplication.enApplicationType.NewInternationalLicense).Fees.ToString();
            lblFees.Text = (await clsApplicationType.FindAsync((int)clsApplication.enApplicationType.NewInternationalLicense)).Fees.ToString();
        ...
        private async void btnIssueLicense_Click(object sender, EventArgs e)
        {
           ...
           clsInternationalLicense InternationalLicense= new clsInternationalLicense();
            ...
            InternationalLicense.PaidFees = (await clsApplicationType.FindAsync((int)clsApplication.enApplicationType.NewInternationalLicense)).Fees;
