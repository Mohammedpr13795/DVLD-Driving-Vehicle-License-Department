...
namespace DVLD.Licenses
{
    public partial class frmRenewLocalDrivingLicenseApplication: Form
    {
        ...
        private async void frmRenewLocalDrivingLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = ((await clsApplicationType.FindAsync((int)clsApplication.enApplicationType.RenewDrivingLicense))).Fees.ToString();
            lblCreatedByUser.Text = clsGlobal.CurrentUser.UserName;

        }

        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(object sender , ctrlDriverLicenseInfoWithFilterEventArgs e)
        {
        ...
        private async void btnRenewLicense_Click(object sender, EventArgs e)
        {
            ...
            clsLicense NewLicense = await ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.RenewLicenseAsync(txtNotes.Text.Trim(),clsGlobal.CurrentUser.UserID);
