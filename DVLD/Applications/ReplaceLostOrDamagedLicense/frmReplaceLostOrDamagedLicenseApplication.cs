...
namespace DVLD.Applications.ReplaceLostOrDamagedLicense
{
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        private async void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = (await clsApplicationType.FindAsync(_GetApplicationTypeID())).Fees.ToString();
        }
        ...
        private async  void btnIssueReplacement_Click(object sender, EventArgs e)
        {
            ...
            clsLicense NewLicense = await
               ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.ReplaceAsync (_GetIssueReason(),
